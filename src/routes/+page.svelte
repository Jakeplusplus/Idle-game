...
<style>
  ...
  .forest-panel {
    ...
    background: linear-gradient(
      ...
      linear-gradient(
        90deg,
        rgba(195, 164, 123, 0.08),
        transparent 35%,
        rgba(130, 182, 200, 0.07)
      );
    border-color: #695944;
    box-shadow:
  ...
  .status-chip {
    ...
    box-shadow: 0 0 0 1px rgba(151, 186, 142, 0.14) inset;
    display: flex;
    flex-direction: column;
    gap: 6px;
  }
  ...
  .cap-signal {
    color: #dfd4ac;
    text-shadow: 0 0 10px rgba(130, 182, 200, 0.28);
  }
  .vault-usage {
    min-width: 140px;
    padding: 12px 14px;
  ...
  .resource-card {
    ...
    box-shadow: 0 0 0 1px rgba(195, 164, 123, 0.16) inset;
  }
  .gold-card {
    border-color: #b89457;
  }
  ...
  .capacity-shell {
    ...
    z-index: 1;
    padding: 8px;
    border: 3px solid #6b5a46;
    background: rgba(22, 26, 24, 0.9);
    box-shadow:
      0 0 0 2px rgba(195, 164, 123, 0.08) inset,
      0 0 18px rgba(130, 182, 200, 0.08);
  }
  .meter-markings {
    position: absolute;
    inset: 8px;
  ...
  @keyframes flash {
    from {
      opacity: 1;
      text-shadow: 0 0 10px rgba(130, 182, 200, 0.8);
    }
    to {
      opacity: 0.5;
      text-shadow: none;
  ...
  .options-dropdown {
    ...
    border: 2px solid #695944;
    padding: 15px;
    box-shadow:
      0 0 0 1px rgba(195, 164, 123, 0.18) inset,
      4px 4px 0px #000;
    z-index: 1;
  }
  .options-title {
  ...
  .themed-card::after {
    ...
    background: linear-gradient(
      90deg,
      rgba(151, 186, 142, 0.08),
      transparent 18%,
      transparent 82%,
      rgba(130, 182, 200, 0.08)
    );
    opacity: 0.7;
  }
  .building-card {
